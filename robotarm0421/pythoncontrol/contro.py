...
def control():
    dr.motor_control_set_angle(id_num=1, joint_num=7, angle=30, speed=20, param=10, mode=1)
    sleep(2)
    dr.set_pose(id_num=1, pl_temp=[41.7, -127.0, 177.2], theta_4_5_6=[0, -45, 0], speed=10, acceleration=10)
    sleep(4)
    dr.set_pose(id_num=1, pl_temp=[49.5, -157.3, 85.4], theta_4_5_6=[0, -45, 0], speed=10, acceleration=10)
    sleep(4)
    dr.motor_control_set_angle(id_num=1, joint_num=7, angle=5,speed=2, param=20, mode=1)
    sleep(2)
    dr.set_pose(id_num=1, pl_temp=[41.7, -127.0, 177.2], theta_4_5_6=[0, -45, 0], speed=10, acceleration=10)
    sleep(2)
    ...
    dr.set_pose(id_num=1, pl_temp=[-120, -145.3, 95.1], theta_4_5_6=[0, -45, 0], speed=10, acceleration=10)
    sleep(4)
    dr.motor_control_set_angle(id_num=1, joint_num=7, angle=30, speed=10, param=10, mode=1)
    sleep(2)
    dr.set_pose(id_num=1, pl_temp=[-120, -145.3, 160.1], theta_4_5_6=[0, -45, 0], speed=10, acceleration=10)
    sleep(4)
    dr.set_pose(id_num=1, pl_temp=[200, 0, 100], theta_4_5_6=[0, 0, 0], speed=10, acceleration=10)
    # dr.motor_control_set_angle(id_num=1, joint_num=7, angle=30, speed=10, param=10, mode=1)
    # sleep(5)
    # dr.motor_control_set_angle(id_num=1, joint_num=7, angle=12, speed=2, param=10, mode=1)
    # sleep(2)
    # sleep(15)
    # dr.set_pose(id_num=1, pl_temp=[200, 0, 100], theta_4_5_6=[0, 0, 0], speed=10, acceleration=10)
...
def controlwave():
    ...
    dr.motor_control_set_angle(id_num=1, joint_num=7, angle=50, speed=10, param=20, mode=1)
    sleep(3)
...
def controlGrab():
    ...
    sleep(2)
    dr.motor_control_set_angle(id_num=1, joint_num=4, angle=48, speed=10, param=20, mode=1)
    # sleep(1)
    # dr.motor_control_set_angle(id_num=1, joint_num=7, angle=30, speed=10, param=20, mode=1)
    sleep(3)
    dr.motor_control_set_angle(id_num=1, joint_num=7, angle=0, speed=10, param=20, mode=1)
